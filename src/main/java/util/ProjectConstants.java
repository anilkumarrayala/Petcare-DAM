...
public class ProjectConstants {
    ...
    private    List ColumnOrder =
            Arrays.asList(new String[] {"AssetID", "Title" , "LegacyAssetVersion", "ExportDate", "ImportedDate", "EmbargoDate","ExpirationDate","IsLatestVersion",
                    ...
                    "VERP","SubBrand","CoverageStartDate","CoverageEndDate","InternalZREP","Global/Regional/Local","IncludedCountries","ExcludedCountries","RestrictionDescription","MediaChannel"
    ...
    private  List AprimoSplitReplaceColumnNames = Arrays.asList(new String[] { "FERT","Tag","InPerpetuity","GTIN/EAN/UPC","VERP","Language","SubBrand","CustomerSpecific","CampaignName", "MarsCampaignCode","RightsRestricted","IsLatestVersion",
    ...
    private    List LHSplitReplaceColumnNames =
            Arrays.asList(new String[] {"FERT","Tag","Asset in Perpetuity?","GTIN/EAN/UPC","VERP","Language","Sub-Brand","Customer Specific","Campaign/Promotional Name", "Mars Campaign Code","Rights Restricted?","Is Latest Version",
                    "Transparent Background?","Platform Specifications","Source File?","Data Classification","Brand","Language","Image Position/Slot", "Sub-Brand","Segment/Flavor 2",
                    "Master or Localization/Adaptation?","Product Image Angle", "Internal ZREP","Global/Regional/Local","Included Countries","Excluded Countries","Media Channel","Restriction Description","Rights Management Type","&LINKS:ARTESIA.LINKTYPE.EXTRACTEDPDF", "&LINKS:ARTESIA.LINKTYPE.COPYCONTENTOF","&LINKS:ARTESIA.LINKTYPE.EXTRACTEDPDF.CHILD","&LINKS:USR-AST",
